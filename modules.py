...
always_bad = "#%&/+,:<=>?@[~]\\^`\t\n\r\x0b\x0c"
always_bad_seq = ["bash", "man", "less", "pinfo","screen", "lynx", "gdb", "git", "ed", "except", "script", "module", "export", "tmux", "nmap", "ruby", "perl", "rnano", "ftp", "php", "sql", "maria", "su"]
...
def check_chal4(x):
	bad_chars = '!\"\'*-{|};'
	bad_seq = ["sh", "rm", "vi", "vim", "emacs", "joe", "py", "find", "mo"]
...
def check_chal5(x):
	bad_chars = '\"\'*{!};'
	bad_seq = ["sh", "rm", "vi", "vim", "emacs", "joe", "py", "find", "nano", "nc", "mo"]
...
def check_chal6(x):
	bad_chars = '!\"$\'()*-{|};'
	bad_seq = ["sh", "rm", "vim", "emacs", "joe", "py", "find", "nano", "tee", "nc", "echo", "mo"]
